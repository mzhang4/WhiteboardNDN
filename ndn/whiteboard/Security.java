...
public class Security
{
  ...
  initialize(Face face)
  {
    KeyChain keyChain = null;
    Name certificateName = null;

    return initialize(face, certificateName);
  }

  public static KeyChain
  initialize(Face face, Name certificateName)
  {
    KeyChain keyChain = null;
    try {
      ...
      privateKeyStorage.setPublicKeyForKeyName(new Name("/"), KeyType.RSA, DEFAULT_RSA_PUBLIC_KEY_DER);
      privateKeyStorage.setPrivateKeyForKeyName(new Name("/"), KeyType.RSA, DEFAULT_RSA_PRIVATE_KEY_DER);
    }
    catch (Exception e){
